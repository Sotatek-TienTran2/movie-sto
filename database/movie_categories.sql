...
CREATE TABLE `movie_categories` (
  ...
  UNIQUE KEY `movie_categories` (`idMovie`,`idCategories`),
  KEY `b-c_idx` (`idCategories`),
  KEY `b-b_idx` (`idMovie`),
  CONSTRAINT `b-b` FOREIGN KEY (`idMovie`) REFERENCES `movie` (`IdMovie`)
...
INSERT INTO `movie_categories` VALUES (1,3),(1,34),(1,46),(1,52),(2,1),(2,2),(2,3),(2,5),(2,39),(2,42),(2,46),(2,52),(3,2),(5,1),(5,4),(8,6);
